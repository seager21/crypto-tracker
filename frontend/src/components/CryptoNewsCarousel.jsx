              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="ml-auto text-xs bg-crypto-blue/20 text-crypto-blue px-2 py-1 rounded">
                  ...
                  <div className="flex justify-end">
                    <span className="text-crypto-blue text-xs flex items-center">
                      Read more
            ...
            <div className="p-6">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 mb-6">
                  {selectedArticle.description || selectedArticle.content || 'No content available for this article.'}
                </p>
              </div>
